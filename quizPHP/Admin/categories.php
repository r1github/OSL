...
if(isset($_GET['delete'])){
    $sno = $_GET['delete'];
    $delete=true;
    $sql = "DELETE FROM `categories` WHERE `id` = $sno";
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    // update query
      $sql = "UPDATE `categories` SET `name` = '$category' WHERE `categories`.`id` = $sno";
      $result=mysqli_query($conn, $sql);
      if($result){
        $update = true;
      }
                    ...
                    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <form action="/TriviaQuiz/admin1/categories.php" method="POST">
    ...
    <script>
      ...
      Array.from(deletes).forEach((element)=>{
        ...
        if(confirm("Are you sure to delete a note!")){
          console.log("yes");
          window.location =`/TriviaQuiz/admin1/categories.php?delete=${sno}`;
